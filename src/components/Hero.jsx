    ...
    return (
        <section className="container mx-auto flex flex-col md:flex-row justify-between items-center pt-44 pb-6 px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full md:w-1/2 space-y-8">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-500">
                ...
                <p className="text-gray-600 text-lg md:text-xl max-w-xl">Get the most accurate leads, sales people training and conversions, tools and more - all within the some one billing.</p>
